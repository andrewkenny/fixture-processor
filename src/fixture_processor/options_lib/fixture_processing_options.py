...
FIXTURE_CORRECTIONS_OPTIONS = {
    "name": "fixture_corrections",
     ...
     "hybrid_location": of.EntryTextData("VTEP ground location", default="TopLeft", disabled=True, hidden=True, width=15)
     }
...
INSERTS_MODIFIER_OPTIONS = {
    "name": "inserts_modifier_options",
     ...
     "pin2_offset": of.EntryTextData("TJ Mux Pin 2 Offset (⅒ mils): ", default="(1000, 0)", disabled=True, hidden=False, width=8),
     "pin6_offset": of.EntryTextData("TJ Mux Pin 6 Offset (⅒ mils): ", default="(0, 1000)", disabled=True, hidden=False, width=8),
     "block_offset": of.EntryTextData("Transfer Block Offset (⅒ mils): ", default="1000", disabled=True, hidden=False, width=5),
...
FIXTURE_TARGETS = [key for key, data in PROCESS_OPTIONS.items() if of.is_checkbutton(data)]
...
EXTRA_VARIABLES = {'throughput_multiplier': False}
